...
const FOUNDERS = [
  {
    ...
    bio: "Tanay is a Chartered Accountant who completed all three levels on the first attempt, and an MBA from London Business School. His career spans institutional finance, entrepreneurship and long-term capital allocation, from audit and public markets to private equity and mobility. To Vera Vita he brings the discipline of patient capital: rigour, governance and a deep interest in healthcare and longevity.",
    experience:
  ...
  },
  {
    ...
    quote: "A builder by training and by temperament.",
    bio: "Dhruv pairs an MBA from London Business School with a foundation in technology and engineering. At the Northstar Group he led business development: structuring land transactions and joint ventures, and overseeing $50M in project revenues, 250 acres under development and 150,000 sq ft under construction. He also created an investor-exit platform that delivered returns of up to 25 percent CAGR. To Vera Vita he brings the craft of building well, and of building communities that last.",
    experience:
      "Northstar Group, Director, Business Development · Reef Technology, London · Home Pilots, Co-founder · Hewlett Packard",
    education: "MBA, London Business School · Family Business Management, SP Jain · B.Tech (IT), VIT",
  ...
  },
  {
    ...
    quote: "Great institutions shape people long before they serve them.",
    bio: "Arudra is the founder of Vera Vita and a Wholetime Director at Orient BlackSwan, with a decade in education and publishing across the subcontinent. He rose from Management Trainee to Director, and founded his first company, RNC Polymers, straight out of college. To Vera Vita he brings a people-first sensibility, centred on learning, empathy, culture and long-term relationships.",
    experience:
